...
namespace BloodBankMS
{
    public partial class Form3 : Form
    {
        ...
        private byte[] image;
        private Form5 conObj1;
        private Form5 oldConObj;
        ...
        private void loadAll(string userID)
        {
            try
            {
                ...
                loadData4(userID);
                loadData5(userID);
                //conObj1 = new Form5(userID, userName, city, bloodGroup, contactNO, image);
                image = null;
                ...
                {
                    oldConObj = (Form5)panel2.Controls[panel2.Controls.Count - 2];
